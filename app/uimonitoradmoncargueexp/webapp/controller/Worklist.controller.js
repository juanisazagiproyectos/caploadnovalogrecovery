sap.ui.define([
    ...
    return BaseController.extend("com.esenttia.admoncargueexp.uimonitoradmoncargueexp.controller.Worklist", {
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/Status".length)
            });
        },
